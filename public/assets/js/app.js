...
//   container.classList.remove( "fade-in" );
  ...
  fetchData( url.currentWeather( lat, lon ), function ( currentWeather )
  {
    ...
    const weatherIcon =
      description === "broken clouds" ? "04d" : icon;
    ...
    card.innerHTML = `
      ...
      <div class="weapper">
        ...
        <img
          src="./assets/images/weather_icons/${ weatherIcon }.png"
          width="64"
          height="64"
          alt="${ description }"
          class="weather-icon"
...
const weatherVideoMap = {
  "clear sky": "clear.mp4",
  "few clouds": "cloudy.mp4",
  "scattered clouds": "cloudy.mp4",
  "broken clouds": "cloudy.mp4",
  "overcast clouds": "cloudy.mp4",
  "light rain": "rain.mp4",
...
// Lowercase match to avoid case issues
const matchedVideo = weatherVideoMap[description.toLowerCase()] || "clear.mp4";

// Update video background if element exists
if (videoElement) {
  const source = videoElement.querySelector("source");
  if (source && source.getAttribute("src") !== `./assets/videos/${matchedVideo}`) {
    source.setAttribute("src", `./assets/videos/${matchedVideo}`);
    videoElement.load(); // Reload to apply new source
  }
}
  } );
};
